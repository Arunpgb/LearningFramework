...
public ExcelFramework(String path) {
	  ...
	  // find whether sheets exists	
		...
		public static void main(String arg[]) throws IOException{
			...
			ExcelFramework datatable = null;
			

				/* datatable = new ExcelFramework(System.getProperty("user.dir")+"\\src\\com\\qtpselenium\\xls\\Controller.xlsx");
